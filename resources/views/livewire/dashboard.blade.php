        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="bg-indigo-50 flex-grow py-12 px-10">
                <div class="flex justify-between">
                    ...
                    <h1 class="text-4xl font-bold text-indigo-900 mt-">Welcome to Kally Threading!</h1>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div class="flex items-center justify-around p-6 bg-white w-64 rounded-xl space-x-2 mt-10 shadow-lg">
                        <div>
                        <span class="text-sm font-semibold text-gray-400">Total Packages</span>
                        <h1 class="text-2xl font-bold">@if($packages){{$packages}}@else 0 @endif </h1>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center justify-around p-6 bg-white w-64 rounded-xl space-x-2 mt-10 shadow-lg">
                        ...
                        <h1 class="text-2xl font-bold">@if($total_customer) {{$total_customer}} @else 0 @endif</h1>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center justify-around p-6 bg-white w-64 rounded-xl space-x-2 mt-10 shadow-lg">
                        <div>
                        <span class="text-sm font-semibold text-gray-400">Total Membership Taken</span>
                        <h1 class="text-2xl font-bold">@if($total_customer_deals) {{$total_customer_deals}} @else 0 @endif</h1>
                        </div>
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
